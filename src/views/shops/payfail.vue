  ...
  <div style="background-color: #fff; height: 100%;">
    <div class="express" style="border: none;">
      <div class="info status_image_and_word">
        ...
        <img src='http://files.sweetysoft.com//image/399/btn_fail@2x.png'/>
      ...
      <div style="margin-top: 20%;">
        <img src="http://files.sweetysoft.com//image/400/failurebutton@3x.png" @click="go_shops" style="width: 76%; height: 50px;"/>
      </div>
    </div>
  </div>
</template>
