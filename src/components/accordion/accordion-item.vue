   ...
   <div class="accordion-item-box" @click="onItemClick" >
     <div class="accordion-item-cell">
       ...
       <div class="accordion-item-cell-hd accordion-item-cell-primary">
         <img class="arrow_image" src="http://files.sweetysoft.com//image/446/arrow_down.png" v-if="duty_selected"/>
         <img class="arrow_image" src="http://files.sweetysoft.com//image/447/arrow_right.png" v-if="!duty_selected"/>
...
.accordion-item-cell-hd {
  ...
  .hadration {
    color: white;
    border-radius: 5px;
    background-image: url("http://files.sweetysoft.com//image/449/login_button_bg.png");
    position: absolute;
    top: 0;
    bottom: 0;
    margin: auto 0;
